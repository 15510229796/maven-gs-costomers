...
<head>
    ...
    <SCRIPT type="text/javascript">
        $(function() {
            //得到焦点
            $("#clientelePassword").focus(function() {
                $("#left_hand").animate({
                    left : "150",
                    top : " -38"
                }, {
            ...
            //失去焦点
            $("#clientelePassword").blur(function() {
...
<DIV
    ...
    <form id="loginForm">
        <P style="padding: 30px 0px 10px; position: relative;">
            <SPAN class="u_logo"></SPAN> <INPUT class="ipt" name="clienteleNumber" type="text"
                                                placeholder="请输入用户名" value="">

        </P>

        <P style="position: relative;">
            <SPAN class="p_logo"></SPAN> <INPUT class="ipt" name="clientelePassword" id="clientelePassword"
